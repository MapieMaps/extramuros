equipements_names = ["Accès PMR", "Doc. unique de secu", "Espace repas", "Fauteuils ergonomiques", "Firewall", "Imprimante", "Internet Haut Débit", "Parking Gratuit"]
equipements_names.each do |equipement_name|
